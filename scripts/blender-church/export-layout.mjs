/**
 * Write the church lot's world frame to layout.json for capture.mjs.
 *
...
const lot = ENTERABLE_LOTS.find((l) => l.name === "church");
if (!lot) throw new Error("church lot missing");

// Every kit wall frame with its openings, in lot-local metres. church.py and
...
const layout = {
  generator: "scripts/blender-church/export-layout.mjs",
  walls,
  lot: {
    x: lot.x,
    z: lot.z,
