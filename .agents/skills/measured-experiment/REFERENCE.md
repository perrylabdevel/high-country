# Measured experiment: detailed reference

This is retrieval-only supporting material. Read the section relevant to the current task; the root skill defines the trigger and hard invariants.
