...
export function createMaterialPanel(options: {
  ...
  folders.terrain.add(materialSettings, "terrainStochastic", 0, 1, 0.05).name("tile variation").onChange(onTerrain);
  ...
  folders.walls.add(materialSettings, "wallStochastic", 0, 1, 0.05).name("stochastic").onChange(onWalls);
